...
/**
 * Generated class for type {@link de.hybris.platform.jalo.GenericItem Head}.
 */
@SuppressWarnings({"deprecation","unused","cast","PMD"})
public abstract class GeneratedHead extends GenericItem
{
	 ...
	 * @return the codeHead - Codice Reparto
	 */
	 ...
	 * @param value the codeHead - Codice Reparto
	 */
	 ...
	 * @return the name - Nome reparto.
	 */
	public String getName(final SessionContext ctx)
	{
		if( ctx == null || ctx.getLanguage() == null )
		{
			throw new JaloInvalidParameterException("GeneratedHead.getName requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>Head.name</code> attribute. 
	 * @return the localized name - Nome reparto.
	 */
	 ...
	 * @param value the name - Nome reparto.
	 */
	public void setName(final SessionContext ctx, final String value)
	{
		...
		{
			throw new JaloInvalidParameterException("GeneratedHead.setName requires a session language", 0 );
		}
