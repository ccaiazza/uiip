...
import org.training.constants.HospitalbackofficeConstants;
 ...
 */
public class HospitalbackofficeManager extends GeneratedHospitalbackofficeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(HospitalbackofficeManager.class.getName());
	 ...
	 */
	public static HospitalbackofficeManager getInstance()
	{
		return (HospitalbackofficeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(HospitalbackofficeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public HospitalbackofficeManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of HospitalbackofficeManager called.");
		}
	}
