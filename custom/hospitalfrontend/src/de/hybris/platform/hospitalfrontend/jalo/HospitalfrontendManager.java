 ...
 */
package de.hybris.platform.hospitalfrontend.jalo;
...
/**
 * This is the extension manager of the Hospitalfrontend extension.
 */
public class HospitalfrontendManager extends GeneratedHospitalfrontendManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(HospitalfrontendManager.class);
	 ...
	 */
	public static HospitalfrontendManager getInstance()
	{
		return (HospitalfrontendManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(HospitalfrontendConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public HospitalfrontendManager() // NOPMD 
	{
		LOG.debug("constructor of HospitalfrontendManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of HospitalfrontendManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of HospitalfrontendManager called, current tenant: {}", getTenant().getTenantID());
	}
