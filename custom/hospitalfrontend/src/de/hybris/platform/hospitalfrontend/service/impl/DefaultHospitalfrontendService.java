...
public class DefaultHospitalfrontendService implements HospitalfrontendService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultHospitalfrontendService.class);
	...
	{
		return DefaultHospitalfrontendService.class.getResourceAsStream("/hospitalfrontend/sap-hybris-platform.png");
	}
