 ...
 */
@IntegrationTest
public class DefaultTrainingServiceIntegrationTest extends ServicelayerBaseTest
{
	@Resource
	...
	{
		// given
		final String logoCode = "trainingPlatformLogo";

		// when
		final String logoUrl = trainingService.getHybrisLogoUrl(logoCode);
