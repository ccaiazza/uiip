...
/**
 * Global class for all Hospitalwebservices constants. You can add global constants for your extension into this class.
 */
@SuppressWarnings({"deprecation","squid:CallToDeprecatedMethod"})
public final class HospitalwebservicesConstants extends GeneratedHospitalwebservicesConstants
{
	public static final String EXTENSIONNAME = "hospitalwebservices";
