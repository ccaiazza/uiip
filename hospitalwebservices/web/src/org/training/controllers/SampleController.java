...
import org.training.data.UserDataList;
import org.training.dto.SampleWsDTO;
import org.training.dto.TestMapWsDTO;
import org.training.dto.UserWsDTO;
import org.training.dto.UsersListWsDTO;
import org.training.dto.UsersPageWsDTO;
import org.training.facades.SampleFacades;
import org.training.initializer.TestBean;
...
public class SampleController
{
	 ...
	 * Example :</br>
	 * GET http://localhost:9001/hospitalwebservices/sample/dto/sampleValue
	 *
	 * @param pathVariable
	 ...
	 * Example :</br>
	 * URL : http://localhost:9001/hospitalwebservices/sample/dto</br>
	 * Method : POST</br>
	 ...
	 * <ul>
	 * <li>http://localhost:9001/hospitalwebservices/sample/users
	 * <li>http://localhost:9001/hospitalwebservices/sample/users?fields=users(info)
	 * <li>http://localhost:9001/hospitalwebservices/sample/users?fields=users(BASIC)
	 * <li>http://localhost:9001/hospitalwebservices/sample/users?fields=users(DEFAULT)
	 * <li>http://localhost:9001/hospitalwebservices/sample/users?fields=users(FULL)
	 * <li>http://localhost:9001/hospitalwebservices/sample/users?fields=users(firstName,addresses(street))
	 * </ul>
	 */
	 ...
	 * <ul>
	 * <li>http://localhost:9001/hospitalwebservices/sample/usersPaged
	 * <li>http://localhost:9001/hospitalwebservices/sample/usersPaged?currentPage=1
	 * <li>http://localhost:9001/hospitalwebservices/sample/usersPaged?currentPage=0?pageSize=1
	 * </ul>
	 */
	 ...
	 * <ul>
	 * <li>http://localhost:9001/hospitalwebservices/sample/users/user1
	 * <li>http://localhost:9001/hospitalwebservices/sample/users/user1?fields=info
	 * <li>http://localhost:9001/hospitalwebservices/sample/users/user1?fields=BASIC
	 * <li>http://localhost:9001/hospitalwebservices/sample/users/user1?fields=DEFAULT
	 * <li>http://localhost:9001/hospitalwebservices/sample/users/user1?fields=FULL
	 * <li>http://localhost:9001/hospitalwebservices/sample/users/user1?fields=firstName,addresses(street)
	 * </ul>
	 */
	 ...
	 *
	 * Url: http://localhost:9001/hospitalwebservices/sample/map
	 *
	 */
