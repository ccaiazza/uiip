 ...
 */
package org.training.hospital.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(HospitalFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(HospitalFulfilmentProcessConstants.PARENT_PROCESS);
