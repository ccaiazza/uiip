 ...
 */
package org.training.hospital.core.suggestion;
...
import org.training.hospital.core.suggestion.impl.DefaultSimpleSuggestionService;
...
public class DefaultSimpleSuggestionServiceIntegrationTest extends ServicelayerTransactionalTest
{
	...
	{
		importCsv("/hospitalcore/test/testSimpleSuggestionService.csv", "utf-8");
	}
