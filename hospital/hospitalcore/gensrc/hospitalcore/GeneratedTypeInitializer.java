...
public class GeneratedTypeInitializer extends AbstractTypeInitializer
{
	...
	protected final void performModifyTypes( final ManagerEJB manager, Map params ) throws JaloBusinessException
	{
		// performModifyTypes
				...
				single_createattr_Patient_lastName();
	...
	public void single_createattr_Patient_lastName() throws JaloBusinessException
	{
	...
	protected final void performCreateObjects( final ManagerEJB manager, Map params ) throws JaloBusinessException
	{
		...
		connectRelation(
			...
			single_setAttributeProperties_Patient_lastName();
			...
			single_setAttributeProperties_Patient_dateEntry();
				...
				setDefaultProperties(
					...
					null
						...
						public void single_setAttributeProperties_Patient_lastName() throws JaloBusinessException
						{
