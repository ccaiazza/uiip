...
public class CoreSystemSetup extends AbstractSystemSetup
{
	...
	{
		importImpexFile(context, "/hospitalcore/import/common/essential-data.impex");
		importImpexFile(context, "/hospitalcore/import/common/countries.impex");
		importImpexFile(context, "/hospitalcore/import/common/delivery-modes.impex");
	...
	public void createProjectData(final SystemSetupContext context)
	{
		...
		processCockpit(context, importAccessRights, extensionNames, "cmscockpit",
				"/hospitalcore/import/cockpits/cmscockpit/cmscockpit-users.impex",
				"/hospitalcore/import/cockpits/cmscockpit/cmscockpit-access-rights.impex");

		processCockpit(context, importAccessRights, extensionNames, "productcockpit",
				"/hospitalcore/import/cockpits/productcockpit/productcockpit-users.impex",
				"/hospitalcore/import/cockpits/productcockpit/productcockpit-access-rights.impex",
				"/hospitalcore/import/cockpits/productcockpit/productcockpit-constraints.impex");

		processCockpit(context, importAccessRights, extensionNames, "cscockpit",
				"/hospitalcore/import/cockpits/cscockpit/cscockpit-users.impex",
				"/hospitalcore/import/cockpits/cscockpit/cscockpit-access-rights.impex");

		processCockpit(context, importAccessRights, extensionNames, "reportcockpit",
				"/hospitalcore/import/cockpits/reportcockpit/reportcockpit-users.impex",
				"/hospitalcore/import/cockpits/reportcockpit/reportcockpit-access-rights.impex");

		if (extensionNames.contains("mcc"))
		{
			importImpexFile(context, "/hospitalcore/import/common/mcc-sites-links.impex");
		}
	}
