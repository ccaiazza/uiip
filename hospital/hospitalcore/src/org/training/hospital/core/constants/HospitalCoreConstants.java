...
/**
 * Global class for all HospitalCore constants. You can add global constants for your extension into this class.
 */
public final class HospitalCoreConstants extends GeneratedHospitalCoreConstants
{
	public static final String EXTENSIONNAME = "hospitalcore";


	private HospitalCoreConstants()
	{
		//empty
	}
