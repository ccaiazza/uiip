 ...
 */
package org.training.hospital.test.setup;
...
import org.training.hospital.test.constants.HospitalTestConstants;
import org.training.hospital.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = HospitalTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/hospitaltest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/hospitaltest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/hospitaltest/import/cstickets.impex");
			...
			importImpexFile(context, "/hospitaltest/import/csquotes.impex");
		}
	}
}
