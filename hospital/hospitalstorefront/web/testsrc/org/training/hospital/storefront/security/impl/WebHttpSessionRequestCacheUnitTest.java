...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/hospitalstorefront/electronics/en",
						"https://electronics.local:9002/hospitalstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/hospitalstorefront/electronics/en",
						"https://electronics.local:9002/hospitalstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/hospitalstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/hospitalstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/hospitalstorefront/electronics/en",
						"https://electronics.local:9002/hospitalstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/hospitalstorefront",
						"https://electronics.local:9002/hospitalstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/hospitalstorefront",
						"https://electronics.local:9002/hospitalstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/hospitalstorefront/electronics/en",
						"https://electronics.local:9002/hospitalstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
